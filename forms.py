...
class AddBackgroundImageForm(FlaskForm):
    """Form for adding background images"""

    image = FileField("Upload Image", validators=[InputRequired(message="Please upload an image")])
