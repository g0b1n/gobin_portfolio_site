...
from models import db, connect_db, AdminUser, Project, Photo, WorkHistory, Education, BackgroundImage
from forms import CreateAdminForm, AdminLoginForm, AddProjectForm, EditProjectForm, AddPhotoForm, EditPhotoForm, AddWorkForm, AddEducationForm, AddBackgroundImageForm
...
def home_page():
    ...
    bg_images = BackgroundImage.query.all()

    return render_template('home.html', projects=projects, photos=photos,
                           works=works, schools=schools, bg_images=bg_images)
